...
Route::middleware(['role:user'])->group(function () {
    ...
    Route::put('review/{id}', [App\Http\Controllers\Frontend\HistoryController::class, 'review'])->name('review');
    Route::resources([
...
Route::middleware(['role:admin|customer_service'])->group(function () {
    ...
    Route::get('chats/list', [App\Http\Controllers\Backend\ChatController::class, 'list'])->name('chats.list');
    Route::get('chats/new', [App\Http\Controllers\Backend\ChatController::class, 'new'])->name('chats.new');
    ...
    Route::get('reviews-data', [App\Http\Controllers\Backend\ReviewController::class, 'index'])->name('reviews-data');
    Route::get('reviews-chart', [App\Http\Controllers\Backend\ReviewController::class, 'chart'])->name('reviews-chart');
});
