        ...
        <div class="d-md-flex justify-content-between align-items-center">
            ...
            <nav aria-label="breadcrumb" class="d-inline-block">
                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                    <li class="breadcrumb-item text-capitalize"><a href="#">Produk Kurang Laris</a></li>
        ...
        <div class="row">
            <div class="col-12 mt-4">
                <div class="d-grid gap-2 d-md-flex">
                    <a href="{{ route('discounts-lowest-product.create') }}" class="btn btn-primary mb-3 btn-sm">
                        Tambah Data +
                    </a>
                </div>
                            ...
                            <tbody>
                                ...
                                @foreach($discounts as $discount)
                                    <tr>
                                        ...
                                        <td style="width: 5%;">
                                            <a href="discounts-lowest-product/{{ $discount->id }}/edit" class="btn btn-warning btn-sm mb-2"><i class="fa-solid fa-pen"></i> Edit</a>
...
<script>
    ...
    $(".btn-delete").click(function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "discounts-lowest-product/" + id,
                    type: 'DELETE',
                    data: {
                        "id": id,
