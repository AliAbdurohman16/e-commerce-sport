    ...
    <div class="layout-specing">
        ...
        <div class="col-lg-8 mt-4">
            <div class="card">
                <div class="container">
                    <div class="card-body">
                        <form action="{{ route('discounts-lowest-product.update', $discounts->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-9 col-sm-10 mb-2">
                                                <input name="discount_percentage" id="discount_percentage" type="number" class="form-control @error('discount_percentage') is-invalid @enderror" placeholder="Contoh : 20" value="{{ $discounts->discount_percentage }}">
