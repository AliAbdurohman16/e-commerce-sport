...
<div class="container-fluid">
    <div class="layout-specing">
        <div class="d-md-flex justify-content-between align-items-center">
            <h5 class="mb-0">Orderan Dikirim</h5>

            <nav aria-label="breadcrumb" class="d-inline-block">
                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                    <li class="breadcrumb-item text-capitalize"><a href="#">Orderan</a></li>
                    <li class="breadcrumb-item text-capitalize"><a href="#">Dikirim</a></li>
                        ...
                        <table class="table table-center bg-white mb-0" id="table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom p-3">No Resi</th>
                                    <th class="border-bottom p-3">Jasa Pengirim</th>
                                    <th class="border-bottom p-3">Ongkir</th>
                            ...
                            <tbody>
                                ...
                                @foreach($orderDetails as $detail)
                                    <tr>
                                        ...
                                        <td class="p-3">{{ $detail->order->shippings->first()->resi }}</td>
                                        <td class="p-3">{{ $detail->order->shippings->first()->provider }}</td>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-primary">
                            Estimasi pengiriman paket anda akan sampai pada tanggal {{ date('d-m-Y, H:i', strtotime($detail->order->shippings->first()->estimation)) }}.
                        </div>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-1">:</div>
                                <div class="col-7">
                                    {{ date('H:i, d-m-Y', strtotime($detail->order->shippings->first()->updated_at)) }}
                                </div>
