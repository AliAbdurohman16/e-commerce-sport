                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-icon position-relative">
                                            ...
                                            <input type="text" class="form-control ps-5 @error('name') is-invalid @enderror" placeholder="Nama Lengkap" name="name" value="{{ $customer->name }}" required autocomplete="name">
                                            @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-icon position-relative">
                                            ...
                                            <input type="number" class="form-control ps-5 @error('telephone') is-invalid @enderror" placeholder="Telepon" name="telephone" value="{{ $customer->telephone }}" required autocomplete="telephone">
                                            @error('telephone')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-icon position-relative">
                                            ...
                                            <textarea class="form-control ps-5" placeholder="Alamat Lengkap" name="address" required autocomplete="address">{{ $customer->address }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div><!--end row-->
