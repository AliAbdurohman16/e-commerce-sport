        ...
        <div class="d-md-flex justify-content-between align-items-center">
            ...
            <nav aria-label="breadcrumb" class="d-inline-block">
                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                    <li class="breadcrumb-item text-capitalize"><a href="#">Kategori</a></li>
                            ...
                            <tbody>
                                ...
                                @foreach($categories as $category)
                                    <tr>
                                        ...
                                        <td style="width: 25%;">
                                            <button type="button" class="btn btn-warning btn-sm mb-2" data-bs-toggle="modal" data-bs-target="#edit-modal{{ $category->id }}"><i class="fa-solid fa-pen"></i> Edit</button>
                                            <button type="button" class="btn btn-danger btn-sm mb-2 btn-delete" data-id="{{ $category->id }}"><i class="fa-solid fa-trash"></i> Hapus</button>
                                        </td>
                                    </tr>
                                @endforeach
                                <!-- End -->
            ...
            <Form action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label">Foto Kategori <span class="text-danger">*</span></label>
                                <div class="row">
                                    <div class="col-sm-3 mb-2">
                                        <img src="{{ asset('default/image.png') }}" width="100px" alt="image" class="img-thumbnail img-preview">
                                    </div>
                                    <div class="col-sm-9">
                                        <input type="file" name="image" id="image" class="form-control" value="{{ old('image') }}" accept="image/*" onchange="previewImg()" required>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control" value="{{ old('name') }}" placeholder="Nama Kategori" required>
...
<!-- Modal Edit -->
@foreach ($categories as $category)
<div class="modal fade" id="edit-modal{{ $category->id }}" tabindex="-1" aria-labelledby="LoginForm-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded shadow border-0">
            <div class="modal-header border-bottom">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-3 mb-2">
                                        <img src="{{ asset('storage/categories/' . $category->image) }}" width="100px" alt="image" class="img-thumbnail img-preview">
                                    </div>
                                    <div class="col-sm-9">
                                        <input type="file" name="image" id="image" class="form-control" accept="image/*" onchange="previewImg()">
                                        <div class="invalid-feedback errorimage">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label">Nama Kategori<span class="text-danger">*</span></label>
                                <input type="text" name="name" id="name" class="form-control" value="{{ $category->name }}" placeholder="Nama Kategori" required>
                                <div class="invalid-feedback errorname">
                                </div>
                            </div>
                        </div>
